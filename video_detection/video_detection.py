...
thresh = 0.3
weights = 'darknet/model/05/backup/yolo_v3_final.weights'
netcfg  = 'darknet/model/05/yolo/yolo_v3_test.cfg'
...
data = 'darknet/model/04/yolo/annotate/obj.data'
